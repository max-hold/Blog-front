...
export default function Home({onNavigate, isDarkMode, toggleTheme}: HomeProps) {
  // Start with the middle image (index 1) as requested
      ...
      <div className="flex flex-col lg:flex-row justify-center items-start gap-3 w-full h-auto">
        ...
        <div className="flex-1 w-full lg:sticky lg:top-3 h-auto lg:h-[calc(100vh-24px)] flex items-center md:py-0">
          <div className="bg-bg-muted-2 rounded-[12px] flex-1 w-full h-full overflow-hidden relative min-h-[500px] lg:min-h-0">
            ...
            {/* Selected Work Tab - Bottom Right */}
            ...
            <button
              ...
              className="absolute top-1/2 left-4 md:left-8 -translate-y-1/2 bg-black/20 hover:bg-black/40 backdrop-blur-md rounded-[12px] flex justify-center items-center w-[40px] h-[40px] transition-all border border-white/10 text-white group-hover:bg-black/50 z-20">
              <PhArrowLeftLight />
            </button>
            <button
              onClick={nextSlide}
              aria-label="Next slide"
              className="absolute top-1/2 right-4 md:right-8 -translate-y-1/2 bg-black/20 hover:bg-black/40 backdrop-blur-md rounded-[12px] flex justify-center items-center w-[40px] h-[40px] transition-all border border-white/10 text-white group-hover:bg-black/50 z-20">
              <PhArrowRightLight />
            </button>
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 bg-black/40 px-2 py-2 rounded-[12px] flex items-center gap-3 z-20">
              {heroImages.map((_, index) => (
                <div
                  ...
                  className={`w-[10px] h-[10px] rounded-full cursor-pointer transition-colors ${currentSlide === index ? "bg-white" : "bg-white/40 hover:bg-white"}`}></div>
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col flex-1 justify-center items-start gap-3 w-full py-3 md:py-0">
          ...
          <div className="bg-bg-muted rounded-[12px] flex justify-between items-center w-full my-2 px-8 py-6 transition-colors duration-300">
            ...
            <div onClick={() => onNavigate("work")} className="flex flex-col justify-center items-start gap-[2px] cursor-pointer group">
          ...
          <div className="flex flex-col items-start gap-3 w-full">
            ...
            <div className="flex flex-col md:flex-row items-start gap-3 w-full">
              {/* Project 1 */}
              <div onClick={() => onNavigate("work")} className="bg-bg-primary rounded-[12px] flex-1 w-full h-[497px] overflow-hidden relative group cursor-pointer">
                <div
                  ...
                  style={{backgroundImage: "url(https://picsum.photos/474/796)"}}></div>
              ...
              <div onClick={() => onNavigate("work")} className="bg-bg-primary rounded-[12px] flex-1 w-full h-[497px] overflow-hidden relative group cursor-pointer">
                <div
                  className="w-full h-full bg-cover bg-center transition-all duration-700 ease-out opacity-80 group-hover:opacity-100 blur-0 group-hover:blur-sm scale-100 group-hover:scale-105"
                  style={{backgroundImage: "url(https://picsum.photos/500/664)"}}></div>
                <div className="absolute top-0 left-0 bg-bg-default rounded-br-[20px] flex items-start gap-[6px] px-4 py-2 pb-3 z-10 transition-colors duration-300">
                  <AnimatedTag text="Darkness" />
                  <div className="absolute -bottom-[20px] left-0">
                    <RoundedEdge className="text-bg-default transition-colors duration-300" />
                  </div>
                  <div className="absolute top-0 -right-[20px]">
            ...
            <div className="flex flex-col md:flex-row items-start gap-3 w-full">
              <div onClick={() => onNavigate("work")} className="bg-bg-primary rounded-[12px] flex-1 w-full h-[497px] overflow-hidden relative group cursor-pointer">
                <div
                  className="w-full h-full bg-cover bg-center transition-all duration-700 ease-out opacity-80 group-hover:opacity-100 blur-0 group-hover:blur-sm scale-100 group-hover:scale-105"
                  style={{backgroundImage: "url(https://picsum.photos/600/600)"}}></div>
                <div className="absolute top-0 left-0 bg-bg-default rounded-br-[20px] flex items-start gap-[6px] px-4 py-2 pb-3 z-10 transition-colors duration-300">
                  <AnimatedTag text="Portrait" />
                  <div className="absolute -bottom-[20px] left-0">
                    <RoundedEdge className="text-bg-default transition-colors duration-300" />
                  </div>
                  <div className="absolute top-0 -right-[20px]">
              ...
              <div onClick={() => onNavigate("work")} className="bg-bg-primary rounded-[12px] flex-1 w-full h-[497px] overflow-hidden relative group cursor-pointer">
                <div
                  className="w-full h-full bg-cover bg-center transition-all duration-700 ease-out opacity-80 group-hover:opacity-100 blur-0 group-hover:blur-sm scale-100 group-hover:scale-105"
                  style={{backgroundImage: "url(https://picsum.photos/470/726)"}}></div>
                <div className="absolute top-0 left-0 bg-bg-default rounded-br-[20px] flex items-start gap-[6px] px-4 py-2 pb-3 z-10 transition-colors duration-300">
                  <AnimatedTag text="Abstract" />
                  <div className="absolute -bottom-[20px] left-0">
                    <RoundedEdge className="text-bg-default transition-colors duration-300" />
                  </div>
                  <div className="absolute top-0 -right-[20px]">
            ...
            <div className="flex flex-col md:flex-row items-start gap-3 w-full">
              <div onClick={() => onNavigate("work")} className="bg-bg-primary rounded-[12px] flex-1 w-full h-[497px] overflow-hidden relative group cursor-pointer">
                <div
                  className="w-full h-full bg-cover bg-center transition-all duration-700 ease-out opacity-80 group-hover:opacity-100 blur-0 group-hover:blur-sm scale-100 group-hover:scale-105"
                  style={{backgroundImage: "url(https://picsum.photos/500/665)"}}></div>
                <div className="absolute top-0 left-0 bg-bg-default rounded-br-[20px] flex items-start gap-[6px] px-4 py-2 pb-3 z-10 transition-colors duration-300">
                  <AnimatedTag text="Fashion" />
                  <div className="absolute -bottom-[20px] left-0">
                    <RoundedEdge className="text-bg-default transition-colors duration-300" />
                  </div>
                  <div className="absolute top-0 -right-[20px]">
              ...
              <div onClick={() => onNavigate("work")} className="bg-bg-primary rounded-[12px] flex-1 w-full h-[497px] overflow-hidden relative group cursor-pointer">
                <div
                  className="w-full h-full bg-cover bg-center transition-all duration-700 ease-out opacity-80 group-hover:opacity-100 blur-0 group-hover:blur-sm scale-100 group-hover:scale-105"
                  style={{backgroundImage: "url(https://picsum.photos/467/700)"}}></div>
                <div className="absolute top-0 left-0 bg-bg-default rounded-br-[20px] flex items-start gap-[6px] px-4 py-2 pb-3 z-10 transition-colors duration-300">
                  <AnimatedTag text="Urban" />
                  <div className="absolute -bottom-[20px] left-0">
                    <RoundedEdge className="text-bg-default transition-colors duration-300" />
                  </div>
                  <div className="absolute top-0 -right-[20px]">
            ...
            <div className="flex flex-col md:flex-row items-start gap-3 w-full">
              <div onClick={() => onNavigate("work")} className="bg-bg-primary rounded-[12px] flex-1 w-full h-[497px] overflow-hidden relative group cursor-pointer">
                <div
                  className="w-full h-full bg-cover bg-center transition-all duration-700 ease-out opacity-80 group-hover:opacity-100 blur-0 group-hover:blur-sm scale-100 group-hover:scale-105"
                  style={{backgroundImage: "url(https://picsum.photos/500/625)"}}></div>
                <div className="absolute top-0 left-0 bg-bg-default rounded-br-[20px] flex items-start gap-[6px] px-4 py-2 pb-3 z-10 transition-colors duration-300">
                  <AnimatedTag text="Minimal" />
                  <div className="absolute -bottom-[20px] left-0">
                    <RoundedEdge className="text-bg-default transition-colors duration-300" />
                  </div>
                  <div className="absolute top-0 -right-[20px]">
              ...
              {/* Balenciaga Special Card */}
              <div onClick={() => onNavigate("work")} className="bg-bg-primary rounded-[12px] flex-1 w-full h-[497px] overflow-hidden relative group cursor-pointer">
                {/* Image */}
                <div
                  className="w-full h-full bg-cover bg-center transition-all duration-700 ease-out opacity-80 group-hover:opacity-100 blur-0 group-hover:blur-sm scale-100 group-hover:scale-105"
                  style={{backgroundImage: "url(https://picsum.photos/500/666)"}}></div>
                {/* Top Left Label */}
                <div className="absolute top-0 left-0 bg-bg-default rounded-br-[20px] flex items-start gap-[6px] px-4 py-2 pb-3 z-10 transition-colors duration-300">
                  <AnimatedTag text="Editorial" />
                  <div className="absolute -bottom-[20px] left-0">
                    <RoundedEdge className="text-bg-default transition-colors duration-300" />
                  </div>
                  <div className="absolute top-0 -right-[20px]">
